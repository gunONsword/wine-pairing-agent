...
from nodes.skill_node import select_recipe_pairing_skill


def build_graph():
    graph = StateGraph(AgentState)
    graph.add_node("parse_recipe_intent", parse_recipe_intent)
    graph.add_node("select_recipe_pairing_skill", select_recipe_pairing_skill)
    ...
    graph.add_edge("parse_recipe_intent", "select_recipe_pairing_skill")
    graph.add_edge("select_recipe_pairing_skill", "retrieve_candidates")
